...
min_years = default_input("Input minimum number of years in retirement: \n", '18')
...
max_years = default_input("Input maximum number of years in retirement: \n", '40')
...
def main():
    ...
    plt.figure('Outcome by Case (showing first {} runs)'.format(len(plotdata)),
               figsize=(12, 5)) # size is width, height in inches
